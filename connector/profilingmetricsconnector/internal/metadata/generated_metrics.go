...
type metricPprofMemoryAllocatedBytes struct {
	...
	config   PprofMemoryAllocatedBytesMetricConfig // metric config provided by user.
	capacity int                                   // max observed number of data points added to the metric.
}

// init fills pprof.memory.allocated.bytes metric with initial data.
func (m *metricPprofMemoryAllocatedBytes) init() {
	m.data.SetName("pprof.memory.allocated.bytes")
	m.data.SetDescription("Total bytes allocated since program start.")
	m.data.SetUnit("By")
	m.data.SetEmptySum()
...
func (m *metricPprofMemoryAllocatedBytes) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64) {
	if !m.config.Enabled {
		return
	}
...
func (m *metricPprofMemoryAllocatedBytes) updateCapacity() {
...
func (m *metricPprofMemoryAllocatedBytes) emit(metrics pmetric.MetricSlice) {
...
func newMetricPprofMemoryAllocatedBytes(cfg PprofMemoryAllocatedBytesMetricConfig) metricPprofMemoryAllocatedBytes {
	m := metricPprofMemoryAllocatedBytes{config: cfg}
...
type metricPprofMemoryAllocatedObjects struct {
	data     pmetric.Metric                          // data buffer for generated metric.
	config   PprofMemoryAllocatedObjectsMetricConfig // metric config provided by user.
	capacity int                                     // max observed number of data points added to the metric.
}

// init fills pprof.memory.allocated.objects metric with initial data.
func (m *metricPprofMemoryAllocatedObjects) init() {
	m.data.SetName("pprof.memory.allocated.objects")
	m.data.SetDescription("Total number of objects allocated since program start.")
	m.data.SetUnit("1")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricPprofMemoryAllocatedObjects) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64) {
	if !m.config.Enabled {
		return
	}
	dp := m.data.Sum().DataPoints().AppendEmpty()
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricPprofMemoryAllocatedObjects) updateCapacity() {
	if m.data.Sum().DataPoints().Len() > m.capacity {
		m.capacity = m.data.Sum().DataPoints().Len()
	}
}
...
// emit appends recorded metric data to a metrics slice and prepares it for recording another set of data points.
func (m *metricPprofMemoryAllocatedObjects) emit(metrics pmetric.MetricSlice) {
	if m.config.Enabled && m.data.Sum().DataPoints().Len() > 0 {
		m.updateCapacity()
		m.data.MoveTo(metrics.AppendEmpty())
		m.init()
...
func newMetricPprofMemoryAllocatedObjects(cfg PprofMemoryAllocatedObjectsMetricConfig) metricPprofMemoryAllocatedObjects {
	m := metricPprofMemoryAllocatedObjects{config: cfg}
...
// init fills pprof.memory.inuse.bytes metric with initial data.
func (m *metricPprofMemoryInuseBytes) init() {
	m.data.SetName("pprof.memory.inuse.bytes")
	m.data.SetDescription("Bytes currently live in the heap.")
	m.data.SetUnit("By")
	m.data.SetEmptyGauge()
}

func (m *metricPprofMemoryInuseBytes) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64) {
	if !m.config.Enabled {
		return
	}
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricPprofMemoryInuseBytes) updateCapacity() {
...
// emit appends recorded metric data to a metrics slice and prepares it for recording another set of data points.
func (m *metricPprofMemoryInuseBytes) emit(metrics pmetric.MetricSlice) {
...
func newMetricPprofMemoryInuseBytes(cfg PprofMemoryInuseBytesMetricConfig) metricPprofMemoryInuseBytes {
	m := metricPprofMemoryInuseBytes{config: cfg}
...
type metricPprofMemoryInuseObjects struct {
	data     pmetric.Metric                      // data buffer for generated metric.
	config   PprofMemoryInuseObjectsMetricConfig // metric config provided by user.
	capacity int                                 // max observed number of data points added to the metric.
}

// init fills pprof.memory.inuse.objects metric with initial data.
func (m *metricPprofMemoryInuseObjects) init() {
	m.data.SetName("pprof.memory.inuse.objects")
	m.data.SetDescription("Number of objects currently live in the heap.")
	m.data.SetUnit("1")
	m.data.SetEmptyGauge()
}

func (m *metricPprofMemoryInuseObjects) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64) {
	if !m.config.Enabled {
		return
	}
	dp := m.data.Gauge().DataPoints().AppendEmpty()
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricPprofMemoryInuseObjects) updateCapacity() {
	if m.data.Gauge().DataPoints().Len() > m.capacity {
		m.capacity = m.data.Gauge().DataPoints().Len()
	}
}
...
// emit appends recorded metric data to a metrics slice and prepares it for recording another set of data points.
func (m *metricPprofMemoryInuseObjects) emit(metrics pmetric.MetricSlice) {
	if m.config.Enabled && m.data.Gauge().DataPoints().Len() > 0 {
		m.updateCapacity()
		m.data.MoveTo(metrics.AppendEmpty())
		m.init()
...
// RecordPprofMemoryAllocatedObjectsDataPoint adds a data point to pprof.memory.allocated.objects metric.
func (mb *MetricsBuilder) RecordPprofMemoryAllocatedObjectsDataPoint(ts pcommon.Timestamp, val int64) {
